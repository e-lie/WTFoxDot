...
k2 >> kicker("<(VVV(V[.V]V[VV]))(...V)>", dur=.5, amp=2, crush=8, bits=linvar([6,2],24, start=Clock.mod(4)), output=12)
...
b3 >> vibra([0,2,0,0,-2,2], dur=.5, oct=3, amp=[0,0,1,0,0,0]).mpan(2)
b4 >> blip([0,2,0,0,-2,2], dur=[.75,.5], oct=7, amp=[0,1,0,1,0,0]).mpan(3).pause(4,24,12)
b5 >> marimba([0,2,0,0,-2,2], dur=.5, oct=5, amp=[0,0,0,0,1,0]).mpan(4)
